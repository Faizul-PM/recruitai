    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Main Heading */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-primary-foreground mb-6 leading-tight font-serif">
            Stop Filtering.
            <br />
          ...
          <p className="text-lg md:text-xl text-primary-foreground/80 mb-10 max-w-2xl mx-auto">
            Recruit AI replaces resume filtering with true hiring intelligence.
            Our multi-agent system thinks like an experienced recruiter—at massive scale.
          </p>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: "₹4,000 Cr", label: "Market Opportunity" },
              { value: "10M+", label: "Active Job Seekers" },
              { value: "75%", label: "Recruiters Using AI" },
              { value: "24hrs", label: "Time-to-Shortlist" },
            ].map((stat, index) => (
